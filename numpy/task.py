...
#array1 = np.arange(15, 40).reshape(5,5)

#array2 = np.arange(10, 25).reshape(5,3)

#print(array1)
#print(array2)

#difference = np.setdiff1d(array1, array2, assume_unique=False)
#print(difference)
...
#even_aaray1 = np.arange(2,21,2).reshape(5,2)
#print(even_aaray1)


#even_array2 = np.arange(34,43,2).reshape(5,1)
#print(even_array2)


#mx = np.stack(even_aaray1, even_array2)
#print(mx)
